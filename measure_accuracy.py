...
# Results show training data is working well
# But testing data is off a little more than 1 star
# Adjust regularization amount, increasing value lowers testing, but increases training 